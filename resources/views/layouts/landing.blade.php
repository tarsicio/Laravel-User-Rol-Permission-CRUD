...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>Nombre Sistema</b></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
               ...
               {{-- <li><a href="#desc" class="smoothScroll">{{ trans('adminlte_lang::message.description') }}</a></li>
                ...
                <li><a href="https://twitter.com/tarsicio_tic" target="_blank" class="smoothScroll">{{ trans('adminlte_lang::message.contact') }}  @tarsicio_tic</a></li>
            </ul>
    ...
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                ...
                <div>
                    <img class="img-responsive" style="display:block;margin:0 auto 0 auto;" src="{{ asset('/img/laravel2.jpg') }}" alt="Logo Laravel">
                </div>
...
<div id="c">
    <div class="container">
        <p>
            ...
            <br/>
            Modificado por {{ trans('adminlte_lang::message.modificado') }} <a href="http://twitter.com/@tarsicio_tic" target="_blank">@tarsicio_tic</a>
        </p>
